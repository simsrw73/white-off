...
(function() {var css = [
  ...
  "  #CommonFooter::after { display: block; content: \"{ White-Off v1.0.8 }\"; color: black; font-size: 8px; text-align: center; margin-top: -1em; margin-bottom: 1em; }",
  "  form[action*=\'AddPost\'] .ForumReplyToPostArea { background-color: rgba(0, 0, 0, 0.05); -webkit-box-shadow: none; box-shadow: none; margin: 1em 0; padding: 0.5em 1em 1em 1em; border: none; border-top: 1px solid #005ec4; border-right: 1px solid #005ec4; -webkit-border-radius: 0; border-radius: 0; }",
  ...
  "  form[action*=\'AddPost\'] .CommonFormFieldName { margin-left: 4px; }",
  ...
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PlaceHolder1_ctl01_SubscribeToThread { vertical-align: text-bottom; margin-bottom: 1px; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_ctl09_ctl02_IsLocked { margin: 0; vertical-align: text-bottom; margin-bottom: 1px; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_AttachmentSubForm_ctl00_Filename + button { margin-left: 10px; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane { padding-left: 8px; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollSubForm_ctl00_IncludePoll { vertical-align: text-bottom; margin-bottom: 1px; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane > .CommonFormFieldName { margin-left: 0; padding-left: 0; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane > .CommonFormField { color: white !important; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer .CommonFormField, form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer .CommonFormFieldName { margin-left: 0; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input { margin-left: 0; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input[type=\'submit\'] { color: #333; background-color: #e39c4f; border: none; padding: 0.5em 1.5em; width: auto !important; height: auto !important; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input[type=\'submit\']:hover { border: none; }",
  "  form[action*=\'EditPost\'] .CommonFormField, form[action*=\'EditPost\'] .CommonFormFieldName { color: #e39c4f !important; }",
  "  form[action*=\'EditPost\'] .CommonFormFieldName { margin-left: 4px; }",
  "  form[action*=\'EditPost\'] .validationWarning { margin-left: 4px; color: white; }",
  "  form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PlaceHolder1_ctl01_SubscribeToThread { vertical-align: text-bottom; margin-bottom: 1px; }",
