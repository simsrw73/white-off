...
(function() {var css = [
	...
	"  .ForumPostUserAvatar img { display: block; margin: 0 auto; border-radius: 4px; background-color: white; -webkit-transition: -webkit-transform 0.4s ease-in-out; transition: -webkit-transform 0.4s ease-in-out; transition: transform 0.4s ease-in-out; transition: transform 0.4s ease-in-out, -webkit-transform 0.4s ease-in-out; z-index: 1; }",
	...
	"  button, [type=\'button\'], [type=\'reset\'], [type=\'submit\'] { display: inline-block; border: none; border-radius: 2px !important; margin: .25em 0; padding: .5em 1em; text-decoration: none; background: #e39c4f; font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen-Sans, Ubuntu, Cantarell, \"Helvetica Neue\", sans-serif; font-weight: 600; font-size: 1em; line-height: 1; cursor: pointer; text-align: center; min-width: 80px; height: 2.2em; -webkit-transition: all 0.1s; transition: all 0.1s; color: #333; }",
	"  button:hover, [type=\'button\']:hover, [type=\'reset\']:hover, [type=\'submit\']:hover { color: #000; background-color: #f8e8d7; }",
	"  button:active, [type=\'button\']:active, [type=\'reset\']:active, [type=\'submit\']:active { box-shadow: none; }",
	...
	"  .ReplyButton:link, .ReplyButton:visited, .MoreButton:link, .MoreButton:visited { box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12); -webkit-transition: all .1s; transition: all .1s; }",
	...
	"  #navInfo a, #navSites a, #subHeader a { padding: 0.3em 0.7em; border-radius: 5px; color: #005ec4; text-decoration: none; -webkit-transition: background-color 200ms ease-in-out; transition: background-color 200ms ease-in-out; }",
	...
	"  #CommonHeaderUserArea a:link, #CommonHeaderUserArea a:visited { border: 1px solid #005ec4; color: #005ec4; font-weight: 500; letter-spacing: 1px; padding: 0.25em 1em; border-radius: 5px; text-decoration: none; -webkit-transition: background-color 200ms ease-in-out; transition: background-color 200ms ease-in-out; }",
	...
	"  #CommonHeaderUserWelcome .sub a[href*=\"EditProfile\"]::before { -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; display: inline-block; font-style: normal; font-variant: normal; font-weight: normal; line-height: 1; vertical-align: -.125em; content: \"\\f303\"; font-size: 14px; margin-right: 0.3em; }",
	"  #CommonHeaderUserWelcome .sub a[href$=\"logout\"]::before { -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; display: inline-block; font-style: normal; font-variant: normal; font-weight: normal; line-height: 1; vertical-align: -.125em; content: \"\\f011\"; font-size: 14px; margin-right: 0.3em; }",
	...
	"  .CommonSearchContent input, .CommonSearchContentSidebar input { box-sizing: border-box; position: absolute; margin: 0; padding: 0 calc(60px + 1em) 0 1em; height: 100%; width: 100%; border: 1px solid #c3c3c3; background-color: #f4f4f4; color: #c3c3c3; font-size: 16px; letter-spacing: .02em; }",
	"  .CommonSearchContent input::-ms-clear, .CommonSearchContentSidebar input::-ms-clear { display: none !important; }",
	"  .CommonSearchContent input:focus, .CommonSearchContent input:focus, .CommonSearchContentSidebar input:focus, .CommonSearchContentSidebar input:focus { border: none; outline: none; box-shadow: inset 0px 0px 3px 1px #005ec4 !important; color: #626262; }",
	"  .CommonSearchContent input.CommonSearchButton, .CommonSearchContent input.CommonSearchButtonSideBar, .CommonSearchContentSidebar input.CommonSearchButton, .CommonSearchContentSidebar input.CommonSearchButtonSideBar { position: absolute; right: 0; top: 0; width: 60px; height: 100%; margin: 0; padding: 0; background-color: transparent; background-position: center; background-repeat: no-repeat; overflow: hidden; border: none; cursor: pointer; box-shadow: none; transform: none; min-width: auto; }",
	"  #ctl00_bcr_MediaTabs_TabSet.CommonPaneTabSet { Background-color: #c3c3c3; width: 100%; border: none; }",
	"  #ctl00_bcr_MediaTabs_TabSet.CommonPaneTabSet .CommonPaneTab, #ctl00_bcr_MediaTabs_TabSet.CommonPaneTabSet .CommonPaneTabHover, #ctl00_bcr_MediaTabs_TabSet.CommonPaneTabSet .CommonPaneTabSelected { background: none; background-color: #ddd; border-top-left-radius: 2px; border-top-right-radius: 2px; margin: 0; padding: 0; padding: .5em 1em; margin: .5em .5em 0 0; text-decoration: none; }",
	...
	"  .CommonPaneTabSet .CommonPaneTab, .CommonPaneTabSet .CommonPaneTabHover, .CommonPaneTabSet .CommonPaneTabSelected { display: inline-block; padding: .5em 1em; margin: .5em .5em 0 0; border-top-left-radius: 2px; border-top-right-radius: 2px; transform: scale(0.95); transform-origin: bottom; }",
	"  .CommonPaneTabSet .CommonPaneTab { background: linear-gradient(to bottom, silver 0%, #a0a0a0 80%, #909090 100%); }",
	"  .CommonPaneTabSet .CommonPaneTabHover { background-color: #f8e8d7; }",
	"  .CommonPaneTabSet .CommonPaneTabHover .TabButton, .CommonPaneTabSet .CommonPaneTabHover form[action*=\'ReportAbuse\'] .CommonPaneTabSelected, form[action*=\'ReportAbuse\'] .CommonPaneTabSet .CommonPaneTabHover .CommonPaneTabSelected { font-weight: 500; }",
	"  .CommonPaneTabSet .CommonPaneTabSelected { background-color: #e39c4f; transform: scale(1); }",
	...
	"  body.forceColors #insert, body.forceColors #cancel, body.forceColors input, body#image #insert, body#image #cancel, body#image .mceActionPanel input, .CommonPane input[type=\'submit\'], form[action*=\"UploadAttachment\"] input[type=\'submit\'] { background-image: none; background-color: #fcf7f2; color: #666; border-radius: 4px; border: 1px solid  #666; margin-top: 4px !important; margin-right: 4px !important; transform: none; box-shadow: none; }",
	"  body.forceColors #insert:hover, body.forceColors #cancel:hover, body.forceColors input:hover, body#image #insert:hover, body#image #cancel:hover, body#image .mceActionPanel input:hover, .CommonPane input:hover[type=\'submit\'], form[action*=\"UploadAttachment\"] input:hover[type=\'submit\'], body.forceColors #insert:focus, body.forceColors #cancel:focus, body.forceColors input:focus, body#image #insert:focus, body#image #cancel:focus, body#image .mceActionPanel input:focus, .CommonPane input:focus[type=\'submit\'], form[action*=\"UploadAttachment\"] input:focus[type=\'submit\'] { color: #000; border-color: #000; transform: none; box-shadow: none; }",
	...
	"  form[action*=\"QuickReply\"] #CommonOuter { box-shadow: 0 9px 46px 8px rgba(0, 0, 0, 0.14), 0 11px 15px -7px rgba(0, 0, 0, 0.12), 0 24px 38px 3px rgba(0, 0, 0, 0.2); }",
	...
	"  #ctl00_ctl00_bcr_bcr_PostForm_ctl05_ctl09_ctl02_IsLocked { margin: 0; }",
	"  #ctl00_ctl00_bcr_bcr_PostForm_ctl05_AttachmentSubForm_ctl00_Filename + button { margin-left: 10px; }",
	...
	"  form[action*=\'ReportAbuse\'] .CommonPaneTabSelected { background-color: #e39c4f !important; font-weight: 700 !important; width: 92px; height: 30px; padding: 8px; }",
	"  form[action*=\'ReportAbuse\'] .CommonFormArea { padding: 0; }",
	"  form[action*=\'ReportAbuse\'] .CommonFormFieldName > label { color: #e39c4f; text-shadow: 0 2px 2px rgba(0, 0, 0, 0.14); font-size: 20px; }",
	"  form[action*=\'ReportAbuse\'] .CommonFormField > input { margin: 0; height: 2em; }",
	"  .validationWarning { color: transparent; }",
	"  .validationWarning::before { -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; display: inline-block; font-style: normal; font-variant: normal; font-weight: normal; line-height: 1; vertical-align: -.125em; content: \"\\f071\"; color: #e39c4f; vertical-align: top; }",
	...
	"  .CommonListRow:hover { background-color: rgba(244, 247, 250, 0.95); }",
	"  .CommonListRowAlt { background-color: #f7f7f7; }",
	"  .CommonListRowAlt:hover { background-color: rgba(247, 247, 247, 0.95); }",
