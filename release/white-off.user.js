...
(function() {var css = [
	...
	"  .CommonSearchContent input, .CommonSearchContentSidebar input { box-sizing: border-box; position: absolute; margin: 0; padding: 0 calc(60px + 1em) 0 1em; height: 100%; width: 100%; border: 1px solid #c3c3c3; background-color: #f4f4f4; color: #c3c3c3; font-size: 16px !important; letter-spacing: .02em; }",
	...
	"  .TabButton, form[action*=\'ReportAbuse\'] .CommonPaneTabSelected { display: block; box-sizing: border-box; background: none; background-color: #e39c4f; height: auto !important; width: 80px !important; padding: .2em; border: none; border-radius: 2px !important; color: #333 !important; font-size: 14px; font-weight: 400; text-decoration: none; text-align: center; }",
	...
	"  body#image .tabs span { background: none; background-color: white; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom: none; }",
	"  body#image .tabs .current { background: none; background-color: white; border-top-left-radius: 4px; border-top-right-radius: 4px; border: 1px solid #999; border-bottom: none; }",
	...
	"  form[action*=\'AddPost\'] .ForumReplyToPostArea { background-color: rgba(0, 0, 0, 0.05); box-shadow: none; margin: 1em 0; padding: .5em 1em 1em 1em; border: none; border-top: 1px solid #005ec4; border-right: 1px solid #005ec4; border-radius: 0; }",
	"  form[action*=\'AddPost\'] .ForumReplyToPostArea .CommonTextButton { margin: 0; padding: 0; }",
	"  form[action*=\'AddPost\'] .CommonFormField, form[action*=\'AddPost\'] .CommonFormFieldName { color: #e39c4f !important; }",
	"  form[action*=\'AddPost\'] button, form[action*=\'AddPost\'] [type=\'button\'], form[action*=\'AddPost\'] [type=\'reset\'], form[action*=\'AddPost\'] [type=\'submit\'] { min-width: 70px; }",
	"  form[action*=\'AddPost\'] button:hover, form[action*=\'AddPost\'] [type=\'button\']:hover, form[action*=\'AddPost\'] [type=\'reset\']:hover, form[action*=\'AddPost\'] [type=\'submit\']:hover { color: #000; background-color: #f8e8d7; }",
	"  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_OptionsPane > .CommonFormField button, form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_OptionsPane > .CommonFormField input[type=\'submit\'] { width: 120px !important; height: 2em !important; border-radius: 2px !important; border: none; background-color: #e39c4f; color: #333; margin: .5em 0 0 .5em !important; }",
	"  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_ctl09_ctl02_IsLocked { margin: 0; }",
	"  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_AttachmentSubForm_ctl00_Filename + button { margin-left: 10px; }",
	...
	"  form[action*=\'EditProfile\'] .CommonGroupedContentArea { box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12); background-color: #fcf7f2; border-radius: 8px; padding: 10px 10px 20px 10px; }",
