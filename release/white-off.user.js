...
(function() {var css = [
  ...
  "  /*! Font Awesome Free 5.6.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) */",
  ...
  "  #CommonFooter::after { display: block; content: \"{ White-Off v1.0.9 }\"; color: black; font-size: 8px; text-align: center; margin-top: -1em; margin-bottom: 1em; }",
  "  form[action*=\'AddPost\'] .ForumReplyToPostArea, form[action*=\'EditPost\'] .ForumReplyToPostArea { background-color: rgba(0, 0, 0, 0.05); -webkit-box-shadow: none; box-shadow: none; margin: 1em 0; padding: 0.5em 1em 1em 1em; border: none; border-top: 1px solid #005ec4; border-right: 1px solid #005ec4; -webkit-border-radius: 0; border-radius: 0; }",
  "  form[action*=\'AddPost\'] .ForumReplyToPostArea .CommonTextButton, form[action*=\'EditPost\'] .ForumReplyToPostArea .CommonTextButton { margin: 0; padding: 0; }",
  "  form[action*=\'AddPost\'] .CommonFormField, form[action*=\'AddPost\'] .CommonFormFieldName, form[action*=\'EditPost\'] .CommonFormField, form[action*=\'EditPost\'] .CommonFormFieldName { color: #e39c4f !important; }",
  "  form[action*=\'AddPost\'] .CommonFormFieldName, form[action*=\'EditPost\'] .CommonFormFieldName { margin-left: 4px; }",
  "  form[action*=\'AddPost\'] button, form[action*=\'AddPost\'] [type=\'button\'], form[action*=\'AddPost\'] [type=\'reset\'], form[action*=\'AddPost\'] [type=\'submit\'], form[action*=\'EditPost\'] button, form[action*=\'EditPost\'] [type=\'button\'], form[action*=\'EditPost\'] [type=\'reset\'], form[action*=\'EditPost\'] [type=\'submit\'] { min-width: 70px; }",
  "  form[action*=\'AddPost\'] button:hover, form[action*=\'AddPost\'] [type=\'button\']:hover, form[action*=\'AddPost\'] [type=\'reset\']:hover, form[action*=\'AddPost\'] [type=\'submit\']:hover, form[action*=\'EditPost\'] button:hover, form[action*=\'EditPost\'] [type=\'button\']:hover, form[action*=\'EditPost\'] [type=\'reset\']:hover, form[action*=\'EditPost\'] [type=\'submit\']:hover { color: #000; background-color: #f8e8d7; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PlaceHolder1_ctl01_SubscribeToThread, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PlaceHolder1_ctl01_SubscribeToThread { vertical-align: text-bottom; margin-bottom: 1px; }",
  "  form[action*=\'AddPost\'] .validationWarning, form[action*=\'EditPost\'] .validationWarning { margin-left: 4px; color: white; }",
  ...
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_OptionsPane #ctl00_ctl00_bcr_bcr_PostForm_ctl05_ctl09_ctl02_IsLocked, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_OptionsPane #ctl00_ctl00_bcr_bcr_PostForm_ctl05_ctl09_ctl02_IsLocked { margin: 0 0 1px 4px; vertical-align: text-bottom; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane { padding-left: 8px; }",
  ...
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane > .CommonFormFieldName, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane > .CommonFormFieldName { margin-left: 0; padding-left: 0; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane > .CommonFormField, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane > .CommonFormField { color: white !important; }",
  ...
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input { margin-left: 0; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input[type=\'submit\'], form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input[type=\'submit\'] { color: #333; background-color: #e39c4f; border: none; padding: 0.5em 1.5em; width: auto !important; height: auto !important; }",
  "  form[action*=\'AddPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input[type=\'submit\']:hover, form[action*=\'EditPost\'] #ctl00_ctl00_bcr_bcr_PostForm_ctl05_PollPane #PollContainer input[type=\'submit\']:hover { border: none; }",
