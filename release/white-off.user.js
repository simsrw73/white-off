...
(function() {var css = [
  ...
  "  .ReplyButton, .MoreButton { -webkit-box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12); box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12); background-image: none; background-color: #e39c4f; -webkit-border-radius: 1em; border-radius: 1em; margin: 0 2px; padding: .1em .5em .1em .5em; opacity: 0.85; -webkit-transition-duration: 0.3s; transition-duration: 0.3s; width: 60px; }",
  "  .ReplyButton:link, .ReplyButton:visited, .MoreButton:link, .MoreButton:visited { -webkit-box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12); box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 1px 5px 0 rgba(0, 0, 0, 0.12); -webkit-transition: all .1s; transition: all .1s; }",
  ...
  "  .CommonSearchContent input, .CommonSearchContentSidebar input { -webkit-box-sizing: border-box; box-sizing: border-box; position: absolute; margin: 0; padding: 0 -webkit-calc(60px + 1em) 0 1em; padding: 0 calc(60px + 1em) 0 1em; height: 100%; width: 100%; border: 1px solid #c3c3c3; background-color: #f4f4f4; color: #c3c3c3; font-size: 16px !important; letter-spacing: .02em; }",
  "  .CommonSearchContent input::-ms-clear, .CommonSearchContentSidebar input::-ms-clear { display: none !important; }",
  "  .CommonSearchContent input:focus, .CommonSearchContent input:focus, .CommonSearchContentSidebar input:focus, .CommonSearchContentSidebar input:focus { border: none; outline: none; -webkit-box-shadow: inset 0px 0px 3px 1px #005ec4 !important; box-shadow: inset 0px 0px 3px 1px #005ec4 !important; color: #626262; }",
  ...
  "  form[action*=\'AddPost\'] .ForumReplyToPostArea { background-color: rgba(0, 0, 0, 0.05); -webkit-box-shadow: none; box-shadow: none; margin: 1em 0; padding: .5em 1em 1em 1em; border: none; border-top: 1px solid #005ec4; border-right: 1px solid #005ec4; -webkit-border-radius: 0; border-radius: 0; }",
  ...
  "  form[action*=\'ReportAbuse\'] .CommonPaneTabSelected { background-color: #e39c4f !important; font-weight: 700 !important; width: -webkit-calc(80px + 1.5em) !important; width: calc(80px + 1.5em) !important; padding: .5em; }",
