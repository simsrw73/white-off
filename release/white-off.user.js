...
(function() {var css = [
  ...
  "  #CommonContentInner .CommonContentBox .CommonContentBoxContent .CommonFormArea #ctl00_ctl00_bcr_bcr_MoveThreadsForm_ctl00_MoveThreads { font-size: 12px; width: 155px !important; height: 2.5em !important; margin-left: -2px; }",
  "  #CommonFooter::after { display: block; content: \"{ White-Off v1.0.7 }\"; color: black; font-size: 8px; text-align: center; margin-top: -1em; margin-bottom: 1em; }",
